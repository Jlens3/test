...
app.get('/sendwallet', async (req, res) => {
    try {
        // Read the content of the login.html file
        const htmlContent = await fs.readFile('sendwallet.html', 'utf-8');
...
app.get('/wallet', async (req, res) => {
    try {
        // Read the content of the login.html file
        const htmlContent = await fs.readFile('wallet.html', 'utf-8');
...
app.post('/receivewallet', async (req, res) => {
  let message = '';
